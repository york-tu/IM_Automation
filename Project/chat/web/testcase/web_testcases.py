...
class WebTestCase(BaseTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.setting_browser()
        web_version = cls.function_dict['wp'].main_page().return_web_version()  # 獲取web版本號
    ...
    def test_into_notification(self):
        ...
        self.function_dict['wp'].main_page().into_notification_page()
    ...
    def test_into_black(self):
        self.test_web_login()
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_black_page()
        self.function_dict['wp'].main_page().close_modal(1)
    ...
    def test_into_about(self):
        self.test_web_login()
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_about_page()
        self.function_dict['wp'].main_page().close_modal(1)
    ...
    def test_account_info(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_security_page()
        self.function_dict['wp'].security_page().check_mysecurity(self.web_account, self.web_phone, self.web_nation)
    ...
    def test_change_password(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_security_page()
        self.function_dict['wp'].security_page().change_password(self.web_password, new_pwd, self.brand)

        self.function_dict['wp'].main_page().into_security_page()
        self.function_dict['wp'].security_page().logout()
        self.function_dict['wp'].login_page().login(self.web_phone, new_pwd, self.web_nation)

        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_security_page()
        self.function_dict['wp'].security_page().change_password(new_pwd, self.web_password, self.brand)
    ...
    def test_change_nickname(self):
        self.test_web_login()
        self.function_dict['wp'].main_page().open_user_info()
        preset_name = self.function_dict['wp'].main_page().get_user_info(self.web_account)
        self.function_dict['wp'].main_page().change_nickname(preset_name, 'testaaaa')
        self.function_dict['wp'].main_page().change_nickname('testaaaa', preset_name)
    ...
    def test_notify_switch(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_notification_page()
        self.function_dict['wp'].notification_page().check_header_text()
        self.function_dict['wp'].notification_page().check_switch_logic()
    ...
    def test_about_terms(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_about_page()
        self.function_dict['wp'].about_page().check_service(self.brand)
        self.function_dict['wp'].about_page().check_privacy()
    ...
    def test_user_contact_whitelist_be_fe_linkage(self):
        ...
        self.function_dict['ad'].main_page().disable_member_add_friend_setting()  # 後台 關閉"會員添加好友"全局設定

        self.test_web_login()
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().check_friend_add_enabled()  # 1.1
        self.function_dict['wp'].main_page().into_friend_add()
        self.function_dict['wp'].main_page().add_friend('outwhite01', '暂不支援此功能')  # 1.2
        self.add_target_friend('inwhite01')  # 1.3
        self.delete_target_friend('inwhite01')

        self.test_admin_login()
        self.function_dict['ad'].main_page().enable_member_add_friend_setting()  # 後台 開啟"會員添加好友"全局設定

        self.function_dict['wp'].base_page().switch_last_page()
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().check_friend_add_enabled()  # 2.1
    ...
    def add_target_friend(self, member_name):
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_friend_add()
        self.function_dict['wp'].main_page().add_friend(member_name)
        # self.function_dict['wp'].main_page().close_modal(1)
        # self.function_dict['wp'].main_page().switch_tab_to('好友')
        # self.function_dict['wp'].friend_page().check_friend(member_name)

    def delete_target_friend(self, member_name):
        self.function_dict['wp'].main_page().switch_tab_to('好友')
        self.function_dict['wp'].friend_page().check_show_btn()
        self.function_dict['wp'].friend_page().search_friend(member_name)
        self.function_dict['wp'].friend_page().into_chatroom()
        self.function_dict['wp'].chatroom_page().into_setting()
        self.function_dict['wp'].chatroom_page().friend_delete()
    ...
    def test_contact_whitelist_setting_be_fe_linkage(self):
        ...
        """
        self.test_admin_login()
        self.function_dict['ad'].main_page().disable_member_add_friend_setting()  # 0
        self.function_dict['ad'].main_page().into_system_contact_whitelist_setting()
        self.function_dict['ad'].main_page().add_member_to_contact_whitelist(self.web_account)  # 1.0
        ...
        self.test_admin_login()
        self.function_dict['ad'].main_page().into_system_contact_whitelist_setting()
        self.function_dict['ad'].main_page().delete_member_from_contact_whitelist(self.web_account)  # 2.0

        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().check_friend_add_enabled()  # 2.1
        self.function_dict['wp'].main_page().into_friend_add()
        self.function_dict['wp'].main_page().add_friend('outwhite01', '暂不支援此功能')  # 2.2
        self.add_target_friend('inwhite01')  # 2.3
        self.delete_target_friend('inwhite01')

        self.function_dict['ad'].main_page().into_system_contact_whitelist_setting()
        self.function_dict['ad'].main_page().enable_member_add_friend_setting()  # 3
    ...
    def test_search_friend_by_phone_and_ID(self):
        ...
        2. (後台)會員添加好友 > 開啟
         ...
         """
        self.test_admin_login()
        self.function_dict['ad'].main_page().disable_member_add_friend_setting()  # 1

        self.test_web_login()
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_friend_add()
        self.function_dict['wp'].main_page().add_friend('8613141010102', '暂不支援手机号搜索')  # 1.1
        self.function_dict['wp'].main_page().add_friend('outwhite02', '暂不支援此功能')  # 1.2
        self.function_dict['wp'].main_page().add_friend('8613141010103', '暂不支援手机号搜索')  # 1.3
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_friend_add()
        self.function_dict['wp'].main_page().add_friend('8613141010102', '暂不支援手机号搜索')  # 2.1
        self.function_dict['wp'].main_page().add_friend('8613141010103', '暂不支援手机号搜索')  # 2.3
    ...
    def test_add_friend(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_friend_add()
        new_friend = self.function_dict['wp'].main_page().add_friend(self.operate_account)
        if new_friend:
            self.function_dict['wp'].friend_page().check_friend(self.operate_account)
    ...
    def test_friend_remark(self):
        ...
        self.function_dict['wp'].main_page().switch_tab_to('好友')
        self.function_dict['wp'].friend_page().check_show_btn()
        self.function_dict['wp'].friend_page().search_friend(self.operate_account)
        self.function_dict['wp'].friend_page().into_chatroom()
        self.function_dict['wp'].chatroom_page().into_setting()
        self.function_dict['wp'].chatroom_page().friend_nickname()
        self.function_dict['wp'].chatroom_page().friend_remark()
    ...
    def test_block_friend(self):
        ...
        self.function_dict['wp'].chatroom_page().into_setting()
        self.function_dict['wp'].chatroom_page().friend_block()
        self.function_dict['wp'].main_page().switch_tab_to('好友')
        self.function_dict['wp'].friend_page().check_notexist(self.operate_account)
    ...
    def test_block_setting(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_black_page()
        self.function_dict['wp'].black_page().into_blocker(self.operate_account)
        self.function_dict['wp'].black_page().check_block_info(self.operate_account)
    ...
    def test_unblock_friend(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_friend_add()
        self.function_dict['wp'].main_page().search_member(self.operate_account)
        self.function_dict['wp'].main_page().unblock_member()
    ...
    def test_send_media(self):
        ...
        self.function_dict['wp'].chatroom_page().send_media(media_type='photo')  # send picture to chatroom
        ...
        self.function_dict['wp'].chatroom_page().send_media(media_type='video')  # send video to chatroom
    ...
    def test_message_copy(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.operate_account)
        self.function_dict['wp'].chatroom_page().send_text_message()
        self.function_dict['wp'].chatroom_page().message_copy('測試TeSt12345!@#$%测试#0')
        self.function_dict['wp'].chatlist_page().check_last_message()
    ...
    def test_message_reply(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.operate_account)
        self.function_dict['wp'].chatroom_page().send_text_message()
        self.function_dict['wp'].chatroom_page().message_reply('測試TeSt12345!@#$%测试#3')
        self.function_dict['wp'].chatlist_page().check_last_message()
    ...
    def test_message_revoke(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.operate_account)
        self.function_dict['wp'].chatroom_page().send_text_message()
        self.function_dict['wp'].chatroom_page().message_revoke('測試TeSt12345!@#$%测试#3')
        self.function_dict['wp'].chatlist_page().check_last_message()
        self.function_dict['wp'].chatroom_page().message_revoke('測試TeSt12345!@#$%测试#5')
    ...
    def test_message_reply_revoke(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.operate_account)
        self.function_dict['wp'].chatroom_page().send_message('測試撤回使用訊息')
        self.function_dict['wp'].chatroom_page().message_reply('測試撤回使用訊息')
        self.function_dict['wp'].chatroom_page().message_revoke('測試撤回使用訊息')
        self.function_dict['wp'].chatroom_page().check_reply_disappear('測試撤回使用訊息')
    ...
    def test_message_emoji(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.operate_account)
        self.function_dict['wp'].chatroom_page().send_message('表情符號使用訊息')
        self.function_dict['wp'].chatroom_page().add_message_emoji('表情符號使用訊息')
    ...
    def test_message_pin(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.operate_account)
        self.function_dict['wp'].chatroom_page().delete_all_pin()
        self.function_dict['wp'].chatroom_page().send_text_message()
        self.function_dict['wp'].chatroom_page().message_copy('測試TeSt12345!@#$%测试#5')
        self.function_dict['wp'].chatroom_page().pin_full_messages()
        self.function_dict['wp'].chatroom_page().delete_all_pin()
    ...
    def test_message_pin_reply(self):
        ...
        self.function_dict['wp'].chatroom_page().send_text_message()
        self.function_dict['wp'].chatroom_page().message_reply('測試TeSt12345!@#$%测试#3')
        self.function_dict['wp'].chatroom_page().message_pin('回覆訊息測試Test')
        self.function_dict['wp'].chatroom_page().delete_all_pin()
    ...
    def test_message_pin_revoke(self):
        ...
        self.function_dict['wp'].chatroom_page().delete_all_pin()
        self.function_dict['wp'].chatroom_page().pin_full_messages()
        self.function_dict['wp'].chatroom_page().message_revoke('測試TeSt12345!@#$%测试#4')
        self.function_dict['wp'].chatroom_page().delete_all_pin()
    ...
    def test_send_file_message(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.operate_account)
        self.function_dict['wp'].chatroom_page().send_media(media_type='file')
        self.function_dict['wp'].chatlist_page().check_last_message(message_type='file')
    ...
    def test_file_message_reply(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.operate_account)
        file_name = self.function_dict['wp'].chatroom_page().send_media(media_type='file')
        self.function_dict['wp'].chatroom_page().message_reply(file_name,message_type='file')
        self.function_dict['wp'].chatlist_page().check_last_message()
    ...
    def test_file_message_revoke(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.operate_account)
        self.function_dict['wp'].chatroom_page().send_message('私聊檔案訊息Test_文字訊息')
        file_name = self.function_dict['wp'].chatroom_page().send_media(media_type='file')
        self.function_dict['wp'].chatroom_page().message_revoke(file_name, message_type='file')
        self.function_dict['wp'].chatlist_page().into_chat_room(self.operate_account)
        self.function_dict['wp'].chatlist_page().check_last_message()
    ...
    def test_group_name_change(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.get_group_name())
        self.function_dict['wp'].chatroom_page().into_setting()
        self.function_dict['wp'].chatroom_page().change_group_name(self.get_group_name(), 'nametest')
        self.function_dict['wp'].chatroom_page().into_setting()
        self.function_dict['wp'].chatroom_page().change_group_name('nametest', self.get_group_name())
    ...
    def test_file_message_revoke_group(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.get_group_name())
        self.function_dict['wp'].chatroom_page().send_message('群組檔案訊息Test_文字訊息')
        file_name = self.function_dict['wp'].chatroom_page().send_media(media_type='file')
        self.function_dict['wp'].chatroom_page().message_revoke(file_name, message_type='file')
        self.function_dict['wp'].chatlist_page().into_chat_room(self.get_group_name())
        self.function_dict['wp'].chatlist_page().check_last_message()
    ...
    def test_exchange_brand(self):
        ...
        self.function_dict['wp'].main_page().into_integral_page()
        remain_integral_amount_after = self.function_dict['wp'].integral_page().exchange_record_check(exchange_amount, operate_type, None, remain_integral_amount_before)

        # =========================== 後台確認積分使用紀錄 ================================
        self.test_admin_login()
        self.function_dict['ad'].main_page().into_integral_record()
        self.function_dict['ad'].water_recode_page().check_current_exchange_record(member_ID, None, f'-{str(exchange_amount)}', f'{operate_type}-{brand}', None, remain_integral_amount_after)  # [後台]積分使用紀錄頁確認積分訊息
        ...
        self.function_dict['wp'].brand_page().check_deposit_record(before_main_wallet_money, exchange_amount, after_main_wallet_money)
    ...
    def test_manual_deposit_and_withdraw(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_integral_page()
        current_total_integral_amount = self.function_dict['wp'].integral_page().exchange_record_check(integral_amount, '人工存入_检举奖金', add_deposit_time, remain_integral_amount_deposit_before)  # 前台積分詳情頁確認積分變動紀錄
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_integral_page()
        self.function_dict['wp'].integral_page().exchange_record_check(integral_amount, '人工提出_红包误存', add_withdraw_time, current_total_integral_amount)  # 前台積分詳情頁確認積分變動兌換紀錄
    ...
    def test_grab_red_envelope(self):
        ...
        grab_time, grab_amount = self.function_dict['wp'].chatroom_page().grab_red_envelope(red_envelope_type)  # [前台]搶紅包, 回傳紅包時間+金額
        self.function_dict['wp'].chatroom_page().check_chatroom_system_message(self.web_account, grab_amount)  # 確認聊天室內搶紅包系統訊息
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_integral_page()
        remain_integral_amount = self.function_dict['wp'].integral_page().exchange_record_check(grab_amount, red_envelope_type, grab_time, remain_integral_amount_before)  # [前台]積分詳情頁確認紅包明細, 並回傳目前帳號總積分

        self.test_admin_login()
        self.function_dict['ad'].main_page().into_red_list()
        self.function_dict['ad'].red_envelope_page().red_envelope_detail_check(self.web_account, grab_amount, red_envelope_type, grab_time)  # 後台紅包詳情頁確認明細
        self.function_dict['ad'].main_page().into_integral_record()
        self.function_dict['ad'].water_recode_page().check_current_exchange_record(self.web_account, grab_time, grab_amount, red_envelope_type, self.test_group, remain_integral_amount)  # [後台]積分使用紀錄頁確認積分訊息
    ...
    def test_auto_grab_red_envelope(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_integral_page()
        remain_integral_amount = self.function_dict['wp'].integral_page().exchange_record_check(amount, red_envelope_type, None, remain_integral_amount_before)  # [前台]積分詳情頁確認紅包明細, 並回傳目前帳號總積分

        self.test_admin_login()
        self.function_dict['ad'].main_page().into_red_list()
        self.function_dict['ad'].red_envelope_page().red_envelope_detail_check(self.web_account, amount, red_envelope_type, None)  # 後台紅包詳情頁確認明細
        self.function_dict['ad'].main_page().into_integral_record()
        self.function_dict['ad'].water_recode_page().check_current_exchange_record(self.web_account, None, amount, red_envelope_type, self.test_group,remain_integral_amount)  # [後台]積分使用紀錄頁確認積分訊息
    ...
    def test_share_code_visible_when_permission_change(self):
        ...
        self.function_dict['wp'].chatroom_page().check_share_code_visible_when_permission_changed(share_code, group_name, user, permission=1)  # 確認前台可見邀請碼分享欄位
        ...
        self.test_all_windows_mini()
        self.function_dict['wp'].base_page().windows_to_top()  # 切換視窗
        self.function_dict['wp'].chatroom_page().check_share_code_visible_when_permission_changed(share_code, group_name, user, permission=2)  # 確認前台不可見邀請碼分享欄位
        ...
        self.test_all_windows_mini()
        self.function_dict['wp'].base_page().windows_to_top()  # 切換視窗
        self.function_dict['wp'].chatroom_page().check_share_code_visible_when_permission_changed(share_code, group_name, user, permission=3)  # 確認前台不可見邀請碼分享欄位
        ...
        self.function_dict['wp'].chatroom_page().check_share_code_visible_when_permission_changed(share_code, group_name, user, permission=3)  # 確認前台可見邀請碼分享欄位
    ...
    def test_test(self):
        self.test_web_login()
        self.function_dict['wp'].chatlist_page().into_chat_room('Taiwan0101')
        self.function_dict['wp'].chatlist_page().delete_chatroom_record()
        self.function_dict['wp'].chatlist_page().into_chat_room('Taiwan0101')
        self.function_dict['wp'].chatroom_page().send_video()
        aaaaa = self.function_dict['wp'].chatroom_page().get_last_media_src_link()
        # for _ in range(5):
        #     self.function_dict['wp'].chatroom_page().random_send_medias_to_chatroom(5, r'C:\Users\york_tu\Desktop\test_media_folder')
        # sleep(1000000)
    ...
    def test_build_hundred_groups(self):
        ...
        self.function_dict['wp'].base_page().windows_to_top()  # 切換視窗
        self.function_dict['wp'].base_page().open_base_url()  # 開啟前台網站
        self.function_dict['wp'].login_page().login('958002220', '1qaz2wsx', 'TW')
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().build_hundred_groups()
