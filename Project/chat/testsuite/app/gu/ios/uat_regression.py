...
app_version = '5.21.0(114262.116)'  # 版本號
...
s1_group_chat_regression_list = [
    ...
    AppTestCase("test_send_message_group"),  # delete history
    AppTestCase("test_message_copy_group"),
    AppTestCase("test_message_reply_group"),
    AppTestCase("test_message_delete_group"),
    AppTestCase("test_message_revoke_group"),  # delete history
    AppTestCase("test_message_pin_group"),
    AppTestCase("test_send_voice_message_group"),  # delete history
    ...
    AppTestCase('test_send_file_message_group'),  # delete history
