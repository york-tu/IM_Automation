...
class PersonalSocialPageLocator:
    ...
    # ============================= 社群個人主頁 ====================================
    social_page_title = base.check_device(
    ...
    follow_btn = base.check_device(
        ...
        iOS=base.data_collation(type_kind='name', type_name='关注'),
    )
    # 個人主頁 > "聊天"鍵
    ...
    search_member = base.check_device(
        ...
        iOS=base.data_collation(type_kind='name', type_name='搜索用户'),
    )
...
class SocialHomePage(Base):
    ...
    def into_member_social_page_from_chat(self, user_nickname):
        ...
        assert self.common.poco_get_text(PersonalSocialPageLocator.social_page_title) == user_nickname
    ...
    def follow_member(self, user_nickname):
        if self.common.poco_get_text(PersonalSocialPageLocator.social_page_title) == user_nickname:
