...
class NotificationPageLocator:
    ...
    @staticmethod
    def env(env):
        env = NotificationPageLocator.base.check_device(
            Android=NotificationPageLocator.base.data_collation(type_kind='textMatches', type_name=f'{env}.*'),
            iOS=NotificationPageLocator.base.data_collation(type_kind='nameMatches', type_name=f'{env}.*')
        )
