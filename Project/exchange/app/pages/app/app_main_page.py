...
from Project.exchange.app.pages.app.app_deposit_page import DepositPageLocator
from Project.exchange.app.pages.app.app_register_page import RegisterPageLocator, RegisterPage
