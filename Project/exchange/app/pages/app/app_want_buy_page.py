...
from Project.exchange.app.pages.app.app_want_sell_page import WantSellPageLocator
...
from Project.exchange.app.pages.app.app_main_page import MainPage, MainPageLocator
