...
class WebTestCase(BaseTestCase, BasePage_Web, BasePage_Admin):
    ...
    def test_change_password(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_security_page()
        self.function_dict['wp'].security_page().change_password(self.web_password, new_pwd)
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_security_page()
        self.function_dict['wp'].security_page().change_password(new_pwd, self.web_password)
    ...
    def test_share_url(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room('test1234')
    ...
    def test_add_friend(self):
        ...
        self.function_dict['wp'].main_page().add_friend(8613542600999)
        self.function_dict['wp'].main_page().close_modal(2)
        self.function_dict['wp'].friend_page().check_friend('test1234')
    ...
    def test_friend_remark(self):
        ...
        self.function_dict['wp'].friend_page().search_friend('test1234')
    ...
    def test_block_friend(self):
        ...
        self.function_dict['wp'].main_page().switch_tab_to('好友')
        self.function_dict['wp'].friend_page().check_notexist('test1234')
    ...
    def test_block_setting(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_black_page()
        self.function_dict['wp'].black_page().into_blocker('test1234')
        self.function_dict['wp'].black_page().check_block_info('test1234')
    ...
    def test_unblock_friend(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().into_friend_add()
        self.function_dict['wp'].main_page().search_member('test1234')
    ...
    def test_message_revoke(self):
        ...
        # self.function_dict['wp'].chatlist_page().check_last_message() // web 尚未有列表最後一筆屏蔽系統功能
    ...
    def test_send_message_group(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.group_name)
        self.function_dict['wp'].chatroom_page().send_text_message()
        self.function_dict['wp'].chatlist_page().check_last_message()
        self.function_dict['wp'].chatroom_page().send_url_message()
        self.function_dict['wp'].chatlist_page().check_last_message()
    ...
    def test_groups_biuld(self):
        ...
        self.function_dict['wp'].main_page().open_user_info()
        self.function_dict['wp'].main_page().check_groups_biuld()
        self.function_dict['wp'].main_page().groups_biuld(self.web_account, self.group_name)
        self.function_dict['wp'].chatlist_page().into_chat_room(self.group_name)
        self.function_dict['wp'].chatlist_page().check_group_build(self.web_account, self.group_name)
    ...
    def test_group_name_change(self):
        ...
        self.function_dict['wp'].chatlist_page().into_chat_room(self.group_name)
        self.function_dict['wp'].chatroom_page().into_setting()
        self.function_dict['wp'].chatroom_page().change_group_name(self.group_name, 'name_test')
        self.function_dict['wp'].chatroom_page().into_setting()
        self.function_dict['wp'].chatroom_page().change_group_name('name_test', self.group_name)
