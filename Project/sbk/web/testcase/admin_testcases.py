...
class AdminTestCase(BaseTestCase, BasePage_Web, BasePage_Admin):
    ...
    def test_admin_switch_languages(self):
        ...
        self.function_dict['ad'].mainPage().switch_languages()
        self.function_dict['ad'].mainPage().change_time()  
    ...
    def test_admin_change_pass(self):
        self.test_admin_login()
        self.function_dict['ad'].mainPage().change_password()
    ...
    def test_partner_and_player_list(self): #商戶與玩家管理列表
        self.test_admin_login()
        self.function_dict['ad'].mainPage().partner_and_player_list() 
    ...
    def test_partner_and_player_keywords_search(self): #商戶與玩家管理關鍵字搜尋
        self.test_admin_login()
        self.function_dict['ad'].mainPage().partner_and_player_keywords_search() 

    @DecorateClass('SPORTSBOOK-T1803')
    def test_partner_and_player_new(self):  #商戶與玩家管理商戶新增
        self.test_admin_login()
        self.function_dict['ad'].mainPage().partner_and_player_partner_new() 

    @DecorateClass('SPORTSBOOK-T1804')
    def test_partner_and_player_partner_edit(self): #商戶與玩家管理商戶編輯
        self.test_admin_login()
        self.function_dict['ad'].mainPage().partner_and_player_partner_edit() 


    @DecorateClass('SPORTSBOOK-T1805')
    def test_partner_and_player_player(self):
        self.test_admin_login()
        self.function_dict['ad'].mainPage().partner_and_player_player() 

    @DecorateClass('SPORTSBOOK-T1806')
    def test_partner_and_player_player_search(self):
        self.test_admin_login()
        self.function_dict['ad'].mainPage().partner_and_player_player_search() 

    @DecorateClass('SPORTSBOOK-T1807')
    def test_partner_and_player_player_edit(self):
        self.test_admin_login()
        self.function_dict['ad'].mainPage().partner_and_player_player_edit() 

    @DecorateClass('SPORTSBOOK-T1808')
    def test_transaction_log(self):
        self.test_admin_login()
        self.function_dict['ad'].mainPage().transaction_log() 

    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_transaction_number(self):
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_transaction_number() 

    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_partner(self):
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_partner() 

    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_player(self):
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_player() 

    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_newly_added_increase(self): #新增一筆調帳(增加)
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_newly_added_increase() 
    
    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_newly_added_decrease(self): #新增一筆調帳(減少)
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_newly_added_decrease() 
    
    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_view_edit(self): #新增一筆調帳(減少)
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_view_edit() 

    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_view_void(self): #調帳作廢
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_view_void() 

    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_submit_for_view(self): #調帳作廢
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_submit_for_view() 

    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_progress_applying(self): #調帳申請與審核_搜尋_進度_申請中
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_progress_applying()    

    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_progress_submit_review(self): #調帳申請與審核_搜尋_進度_提交審核
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_progress_submit_review()  

    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_progress_void(self): #調帳申請與審核_搜尋_進度_作廢
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_progress_void()  

    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_progress_audit(self): #調帳申請與審核_搜尋_進度_審核中
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_progress_audit()  

    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_progress_approved(self): #調帳申請與審核_搜尋_進度_審核通過
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_progress_approved() 
    
    @DecorateClass('SPORTSBOOK-T1809')
    def test_wallet_adjust_progress_reject(self): #調帳申請與審核_搜尋_進度_審核駁回
        self.test_admin_login()
        self.function_dict['ad'].mainPage().wallet_adjust_progress_reject() 
    ...
    #     self.function_dict['ad'].mainPage().into_systum_maintenance()
    ...
    #     self.function_dict['ad'].mainPage().into_systum_app_setting()
    ...
    #     self.function_dict['ad'].mainPage().into_red_integral()
    ...
    #         self.function_dict['wp'].mainPage().check_groups_biuld(boling)
