...
class BaseTestCase(UnittestModule):
    ...
    # 登入帳號
        ...
        self.bank_card = testdata['bank_card']
        self.env = env
        self.brand = brand
        ...
        if not self.env.__contains__('prod'):
            ...
            self.zqb_merchant_id = testdata['zqb_merchant_id']
            self.zqb_private_sign = testdata['zqb_private_sign']
            self.zqb_deposit_callback = testdata['zqb_deposit_callback']
