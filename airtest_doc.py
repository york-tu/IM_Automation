# https://poco-chinese.readthedocs.io/zh_CN/latest/source/poco.proxy.html
# coding=utf-8
...
[文档]    def drag_to(self, target, duration=2.0):
        """
...
[文档]    def scroll(self, direction='vertical', percent=0.6, duration=2.0):
        """
...
[文档]    def pinch(self, direction='in', percent=0.6, duration=2.0, dead_zone=0.1):
        """
...
[文档]    def get_position(self, focus=None):
        """
...
[文档]    def wait_for_appearance(self, timeout=120):
        """
...
[文档]    def wait_for_disappearance(self, timeout=120):
        """
...
[文档]    @refresh_when(PocoTargetRemovedException)
    def attr(self, name):
        """
